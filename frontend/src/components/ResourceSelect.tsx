...
export default function ResourceSelect(props: ResourceSelectInterface) {
  ...
  const dict: dictInterface = {
    ...
    "0.57MW (1.25m/s)": `Current/PowerTimeSeriesKite_VD50_BCS1.25_${props.state.start_year}_${props.state.end_year}.npz`,
    "0.93MW (1.5m/s)": `Current/PowerTimeSeriesKite_VD50_BCS1.5_${props.state.start_year}_${props.state.end_year}.npz`,
    "1.43MW (1.75m/s)": `Current/PowerTimeSeriesKite_VD50_BCS1.75_${props.state.start_year}_${props.state.end_year}.npz`,
    "2.04MW (2.0m/s)": `Current/PowerTimeSeriesKite_VD50_BCS2.0_${props.state.start_year}_${props.state.end_year}.npz`,
    "1.987MW (2.25m/s)": `Current/PowerTimeSeriesKite_VD50_BCS2.25_${props.state.start_year}_${props.state.end_year}.npz`,
    "1.87MW (2.5m/s)": `Current/PowerTimeSeriesKite_VD50_BCS2.5_${props.state.start_year}_${props.state.end_year}.npz`,
    "1.81MW (2.75m/s)": `Current/PowerTimeSeriesKite_VD50_BCS2.75_${props.state.start_year}_${props.state.end_year}.npz`,
